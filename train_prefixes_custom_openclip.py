...
from open_clip_vit_prompt import VisionTransformer
...
for col in range(adapters_per_domain):
    ...
    for did, domain_name in enumerate(train_domains):
        ...
        for name, param in model.named_parameters():
            ...
            if "prefix" in name or "classifier" in name:
...
print("Saving weights to ", f"weights/train_domain_prefixes_list_{args.base_model}_{dataset_name}{args.name_tag}.pt")
torch.save(train_domain_adaters_list, f"weights/train_domain_prefixes_list_{args.base_model}_{dataset_name}{args.name_tag}.pt")
torch.save(classifiers, f"weights/train_domain_prefix_classifiers_{args.base_model}_{dataset_name}{args.name_tag}.pt")